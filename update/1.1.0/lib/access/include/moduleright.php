...
use Awz\Bx24lead\Access\Custom\ComponentConfig;
                ...
                window.awz_right_dialog = {
                    ...
                    reloadItems: function(items, event){
                        ...
                        items.forEach(function(itm){
                            if(itm.getEntityId()==='user' || itm.getEntityType()==='awzbx24lead-user'){
                                let itmEv = {
                                    type: 'users',
                                    id: 'U'+itm.getId(),
                                    key: 'U'+itm.getId(),
                            ...
                            }else if(itm.getEntityType()==='awzbx24lead-group'){
                                let itmEv = {
                                    type: 'groups',
                                    id: 'G'+itm.getId(),
                                    key: 'G'+itm.getId(),
                    ...
                    load: function(groupKey, options){
                        ...
                        if(groupData.hasOwnProperty('members')){
                            for(k in groupData['members']){
                                ...
                                if(itm.type==='users'){
                                    preselectedItems.push(['awzbx24lead-user',itm.id]);
                                }
                                else if(itm.type==='awzbx24lead-user'){
                                    preselectedItems.push(['awzbx24lead-user',itm.id]);
                                }
                                else if(itm.type==='awzbx24lead-group'){
                                    preselectedItems.push(['awzbx24lead-group',itm.id]);
                                }
