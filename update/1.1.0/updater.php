...
if(IsModuleInstalled($moduleId)) {
    ...
    if($connection->getType()=='mysql'){
        $sql = "CREATE TABLE IF NOT EXISTS awz_bx24lead_role (
        ID INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
        NAME VARCHAR(250) NOT NULL,
        PRIMARY KEY (ID)
        );";
        $connection->queryExecute($sql);
        $sql = "CREATE TABLE IF NOT EXISTS awz_bx24lead_role_relation (
        ID INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
        ...
        $connection->queryExecute($sql);
        $sql = "CREATE TABLE IF NOT EXISTS awz_bx24lead_permission (
        ID INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
        ROLE_ID INT(10) UNSIGNED NOT NULL,
    ...
    elseif($connection->getType()=='pgsql' && !$updater->TableExists('awz_bx24lead_permission')){
        $sql = "CREATE TABLE awz_bx24lead_role (
        ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
        NAME varchar(250) NOT NULL,
        PRIMARY KEY (ID)
        );";
        $connection->queryExecute($sql);
        $sql = "CREATE TABLE awz_bx24lead_role_relation (
        ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
        ...
        $connection->queryExecute($sql);
        $sql = "CREATE TABLE awz_bx24lead_permission (
        ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
        ROLE_ID int NOT NULL DEFAULT 0,
        PERMISSION_ID varchar(32) NOT NULL DEFAULT '0',
    ...
    $eventManager->registerEventHandlerCompatible(
        ...
        $moduleId, '\\Awz\\Bx24lead\\Access\\Handlers', 'OnAfterUserUpdate'
    );
    $eventManager->registerEventHandlerCompatible(
        'main', 'OnAfterUserAdd',
        $moduleId, '\\Awz\\Bx24lead\\Access\\Handlers', 'OnAfterUserUpdate'
